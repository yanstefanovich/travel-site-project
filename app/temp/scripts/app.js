...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_menu__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_revealOnScroll__ = __webpack_require__(3);



var menu = new __WEBPACK_IMPORTED_MODULE_0__modules_menu__["a" /* default */]();
...
class RevealOnScroll {
  constructor(elements, offset) {
    this.itemsToReveal = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(elements);
    this.offset = offset;
    this.hideInitially();
  ...
  createWaypoints() {
    ...
    this.itemsToReveal.each(function() {
      ...
      new Waypoint({
        element,
        handler: function() {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).addClass('reveal-item--is-visible')
        },
        offset: that.offset
      });
    });
